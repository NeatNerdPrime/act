...
::card-group
::card{title="MITRE ACT Templates" icon="i-heroicons-document-text" to="/docs/templates"}
Download templates, guides, and workaids
::

::card{title="Contact the MITRE ACT Team" icon="i-heroicons-envelope" to="mailto:act@mitre.org"}
...
::card-group
::card{title="Synthesizes all available Risk Information Sources (RIS’s)" icon="i-heroicons-arrows-pointing-in"}
...
::card{title="More understandable and actionable" icon="i-heroicons-sparkles"}
ACT adds context, clarifies priorities, and both drives and justifies decisions.
::

::card{title="Risk-driven rather than compliance-driven" icon="i-heroicons-scale"}
...
::card{title="Capability-oriented rather than control-oriented" icon="i-heroicons-puzzle-piece"}
...
::callout
**ACT turns “close *every* gap” into “close the *right* gaps” - protecting your mission, your budget, and your sanity.**
::
