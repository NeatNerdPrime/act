---
title: Introduction to MITRE ACT™
...
1. Derive plain-language risk statements from all technical findings _in context_:
    - “Your elevated LDL (“bad cholesterol”) increases the risk of a heart attack by about 5 percent if left untreated over the next decade. However, your elevated HDL (“good cholesterol”) helps to counteract the LDL, and some simple diet changes can improve this further, so I’m not very concerned about it at this time. Your recurring plantar fasciitis, while not life threatening, is more of a concern since you are very active and this is a limiting factor for you right now .”
...
4. Offer decision options with costs, benefits, and trade-offs.
    - “Here’s the cost and recovery time for surgery for your plantar fasciitis, potential side effects, and the risk reduction curve. You can also try physical therapy first, which has less cost and side effects but lower likelihood of success. We’ll get a specialist’s opinion and meet again in 90 days and decide.”
